...
public enum PSL {
    ...
    REGION_DISTANCE_BETWEEN_CLAIMS_WARNING("psregion.region_distance_between_claims_warning", ChatColor.GOLD + "Warning: " + ChatColor.YELLOW + "Placing a protection block closer than %num% blocks to another player's protected region requires explicit consent from its owners: " + ChatColor.AQUA + "%owners%" + ChatColor.YELLOW + "."),
