...
public enum PSL {
    ...
    REGION_DISTANCE_BETWEEN_CLAIMS_WARNING("psregion.region_distance_between_claims_warning", ChatColor.GOLD + "Warning: " + ChatColor.YELLOW + "This protection block is closer than %num% blocks to one or more protected regions. Nearby owners: " + ChatColor.AQUA + "%owners%" + ChatColor.YELLOW + "."),
