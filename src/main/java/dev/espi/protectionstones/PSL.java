...
public enum PSL {
    ...
    REGION_DISTANCE_BETWEEN_CLAIMS_WARNING("psregion.region_distance_between_claims_warning", ChatColor.GOLD + "Warning: " + ChatColor.YELLOW + "The nearest protected region boundary is %num% blocks away. Nearby owners: " + ChatColor.AQUA + "%owners%" + ChatColor.YELLOW + "."),
